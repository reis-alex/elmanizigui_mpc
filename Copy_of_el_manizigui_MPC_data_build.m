...
robot = importrobot('C:\Users\Alex Reis\Desktop\Exoskeleton control\models\meshes\elmanizigui2.urdf');
robot.DataFormat = 'row';
[~, ~, robotacceleration] = SPART_urdf2casadi('C:\Users\Alex Reis\Desktop\Exoskeleton control\models\meshes\elmanizigui2.urdf');
...
opt.n_controls  = 4;
opt.n_states    = 8;
opt.model.function = [[qd1;qd2;qd3;qd4]; robotacceleration([q1;q2;q3;q4],[qd1;qd2;qd3;qd4],[torque1;torque2;torque3;torque4])];
...
for t = 1:tmax
    ...
    aux2 = robotacceleration(xsimu([1:4],t),xsimu(5:8,t),[u(:,t)]);
